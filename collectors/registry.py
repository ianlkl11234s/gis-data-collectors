...
from .lightning_cwa import LightningCwaCollector
...
COLLECTOR_REGISTRY: Tuple[CollectorEntry, ...] = (
    ...
    CollectorEntry(LightningCwaCollector, "氣象署落雷即時收集器", "LIGHTNING_CWA",
                   ("CWA_API_KEY",)),
    ...
    CollectorEntry(AnimalVeterinaryClinicsCollector, "農業部獸醫開業執照收集器", "ANIMAL_VETERINARY_CLINICS"),
    CollectorEntry(AnimalLicensedPetBusinessesCollector, "農業部合法特定寵物業收集器", "ANIMAL_LICENSED_PET_BUSINESSES"),
    CollectorEntry(AnimalProtectionOfficesCollector, "農業部動物保護機關收集器", "ANIMAL_PROTECTION_OFFICES"),
